    ...
    <div className="py-20 px-6 bg-gray-50 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="p-8 rounded-2xl border hover:shadow-lg transition">
          ...
          <button className="mt-6 w-full border py-2 rounded-lg hover:bg-gray-100">
            Get Started
          </button>
        </div>
        ...
        <div className="p-8 rounded-2xl bg-blue-600 text-white shadow-lg scale-105">
          <p className="bg-white text-blue-600 text-xs px-3 py-1 rounded-full inline-block mb-2">
            Most Popular
          </p>
          ...
          <button className="mt-6 w-full bg-white text-blue-600 py-2 rounded-lg hover:bg-gray-100">
            Start Trial
          </button>
        </div>
